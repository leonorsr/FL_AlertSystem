...
from config import DEFAULT_EXPERIMENTS_ROOT, EXPERIMENT_CATALOG, config_to_dict, get_experiment_results_dir
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Flower-based KD experiments for fall detection.")
    parser.add_argument(
        "--experiment",
        default="exp1_kkd_base",
    ...
    parser.add_argument(
        "--results-dir",
        default=None,
        help="Optional directory where run artifacts will be saved. If omitted, results are stored under kd-experiments/<experiment_id>/results/.",
    )
    parser.add_argument(
        "--num-rounds",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of repeated experiment runs with different random seeds.",
    )
