...
from run_strategy import DEFAULT_EXPERIMENT_ID, DEFAULT_RESULTS_ROOT, run_prototype_strategy_experiment


def main() -> None:
    parser = argparse.ArgumentParser(description="Run all advanced class-prototype experiments.")
    ...
    parser.add_argument("--strategies", nargs="+", default=DEFAULT_PROTOTYPE_STRATEGY_ORDER, choices=DEFAULT_PROTOTYPE_STRATEGY_ORDER)
