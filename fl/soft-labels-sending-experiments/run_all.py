...
from run_experiment import DEFAULT_EXPERIMENT_ID, DEFAULT_RESULTS_ROOT, run_probability_payload_experiment


def main() -> None:
    parser = argparse.ArgumentParser(description="Run all probability-payload soft-label experiments.")
    ...
    parser.add_argument("--payloads", nargs="+", default=DEFAULT_PAYLOAD_ORDER, choices=DEFAULT_PAYLOAD_ORDER)
