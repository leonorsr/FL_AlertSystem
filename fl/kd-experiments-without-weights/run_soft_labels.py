...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run KD experiments using only soft labels as communication.")
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=Path(__file__).resolve().parent / "soft labels",
        help="Output root for soft-label experiment folders.",
    )
