...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run KD experiments using class prototypes as no-weight communication.")
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=Path(__file__).resolve().parent / "class prototype",
        help="Output root for class-prototype experiment folders.",
    )
