...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run centralized leave-one-dataset-out experiments on robust_clip windows.")
...
def main() -> None:
    ...
    config_payload = {
        "seed": args.seed,
        "windows_path": str((Path(__file__).resolve().parents[3] / "data" / "preprocessing_results" / "simple" / "robust_clip" / "windows.csv").resolve()),
