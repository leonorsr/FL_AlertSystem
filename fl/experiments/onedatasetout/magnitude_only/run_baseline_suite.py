...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run centralized leave-one-dataset-out experiments on magnitude_only windows.")
...
def main() -> None:
    ...
    config_payload = {
        "seed": args.seed,
        "windows_path": str((Path(__file__).resolve().parents[3] / "data" / "preprocessing_results" / "simple" / "magnitude_only" / "windows.csv").resolve()),
