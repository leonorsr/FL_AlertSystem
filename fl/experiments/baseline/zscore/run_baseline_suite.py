...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run centralized baseline experiments on baseline_zscore windows.")
...
def main() -> None:
    ...
    split_df = split_trials_by_dataset(trial_table, split_config)
